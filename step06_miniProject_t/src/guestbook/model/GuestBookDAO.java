...
public class GuestBookDAO {
	...
	public  static ArrayList<GuestBookBean> selectContents(String option, String content) throws SQLException{
		Connection con = null;	
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		ArrayList<GuestBookBean> alist = null;
		...
		try {
			...
			if (option.equals("title")) {
				pstmt = con.prepareStatement(sql + " where title like ?" +
						" order by num desc");
			}
			else if (option.equals("user")) {
				pstmt = con.prepareStatement(sql + " where author like ?" +
						" order by num desc");
			}
			else if (option.equals("content")) {
				pstmt = con.prepareStatement(sql + " where content like ?" +
						" order by num desc");
			}
			else if(option.equals("title_content")){
				pstmt = con.prepareStatement(sql + " where title or content like ?" +
						" order by num desc");
			}
